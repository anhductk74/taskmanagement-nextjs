      ...
      <form onSubmit={handleSubmit(handleCreateProject)} className="space-y-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div>
            ...
            {errors.endDate?.message && (
              <p className="text-red-500 text-sm">{String(errors.endDate?.message)}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            />
            {errors.pmEmail?.message && (
              <p className="text-red-500 text-sm">{String(errors.pmEmail?.message)}</p>
            )}
          </div>
          <div>
            <label className="font-medium flex items-center gap-1 mb-1">
