...
const GroupedTaskList = ({
  ...
  const handleEnhancedCalendarSave = (data: {
    ...
    const enhancedTaskData = {
      ...
      status: 'TODO',
      priority: 'NORMAL',
      startDate: startDateFormatted || new Date().toLocaleDateString("en-CA").split('T')[0],
      deadline: endDateFormatted || startDateFormatted || new Date().toLocaleDateString("en-CA").split('T')[0],
      deadline: startDateFormatted || new Date().toLocaleDateString("en-CA").split('T')[0],
      creatorId: '',
      assignedToIds: [],
      tags: [],
    };
