        ...
        <div className="flex items-center gap-2">
          ...
          {task.isEditing?.name ? (
            <input
              ...
              className="flex-1 px-2 py-1 border rounded text-sm focus:outline-none focus:border-blue-500 max-w-50"
              autoFocus
            />
          ) : (
            <span
            ...
            >
             ...
             {/* Assignee */}
       <td className="w-[170px] py-1 px-2 border border-gray-200">
        {task.isEditing?.assignee ? (
          ...
          >
            {task.assignee.length > 0 ? (
             ...
             {/* Due Date */}
       <td className="w-[90px] py-1 px-2 border border-gray-200">
        ...
        {task.isEditing?.priority ? (
          ...
          >
            {task.priority}
             ...
             {/* Status */}
       <td className="w-[80px] py-1 px-2 border border-gray-200">
